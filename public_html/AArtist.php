...
if (isset($_GET['award_id'])) {
    $id = $_GET["award_id"];
    $sql = "SELECT winner_artist, artist_title, year, Artist_Award.award_id FROM Artist_Award LEFT JOIN Award ON Award.award_id = Artist_Award.award_id WHERE Artist_Award.award_id = '$id';";
...
<body>
    ...
    Here is more information about this winning artist:
	</h2>
