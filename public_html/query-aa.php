...
if ($stmt1->execute()) {
    ...
    if ($stmt2->execute()) {
        ...
        $sql3 = "INSERT INTO Album_Award (award_id, winner_album, album_prize) VALUES (?, ?, ?)";
        $stmt3 = $conn->prepare($sql3);
        $stmt3->bind_param("sss", $id, $_POST["winner_album"], $_POST["album_prize"]);
...
$sql = "SELECT * FROM Album_Award JOIN Award ON Album_Award.award_id = Award.award_id";
