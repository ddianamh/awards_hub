...
<body>
    ...
    $sql2 = "INSERT INTO Song (song_id, song_title, is_winner_song) VALUES (?, ?, 0)";
    $stmt2 = $conn->prepare($sql2);
    $stmt2->bind_param("is", $id, $_POST["song_title"]);
    ...
    if ($stmt1->execute() && $stmt2->execute()) {
        ...
        $sql = "SELECT * FROM Song JOIN Music ON song_id = music_id";
