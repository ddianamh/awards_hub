...
$sql2 = "INSERT INTO Song_Award (award_id, winner_song, song_prize) VALUES (?, ?, ?)";
$stmt2 = $conn->prepare($sql2);
$stmt2->bind_param("iss", $id, $_POST["winner_song"], $_POST["song_prize"]);
...
$sql = "SELECT * FROM Song_Award JOIN Art_Award ON award_id = award_id";
