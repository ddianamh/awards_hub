...
<h1 style="padding-top: 170px; padding-left: 200px;"> Succesfully added! <?php
...
$sql2 = "INSERT INTO Visual_Award (award_id, winner_visual, visual_title) VALUES (?, ?, ?)";
$stmt2 = $conn->prepare($sql2);
$stmt2->bind_param("isss", $id, $_POST["winner_visual"], $_POST["visual_title"]);
...
$sql = "SELECT * FROM Visual_Award JOIN Art_Award ON award_id = award_id";
